...
GRANT ALL PRIVILEGES ON pi_iot.* TO 'pi'@'localhost';
FLUSH PRIVILEGES;
...
car_id INT(6)
 ...
 INSERT INTO Account(user_name, password, car_id) VALUES("pi_01", "password", 1);

 INSERT INTO Account(user_name, password, car_id) VALUES("pi_02”, "password", 2);
